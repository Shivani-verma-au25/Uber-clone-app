    ...
    <div className='p-7 h-screen flex flex-col justify-between'>
      <div>
        ...
        <form onSubmit={(e) => onSubmitHandler(e)} >
          ...
          <Label className='font-medium text-sm' htmlFor="">What's your name</Label>
          ...
          <p className='text-center my-4 text-xs font-semibold'>All Ready have an Account? <Link to={'/user-login'} className='mb-3 font-bold text-xs text-blue-600'>Login Account</Link> </p>
        </form>
      </div>
      <div>
