...
function ConformedRide({setConformedRidePanel,setLookingForDriver,setVehiclePanel}) {
  return (
    <div>
        ...
        <h3 className='font-semibold text-2xl py-5'>Confirm your ride</h3>
        <div className='flex flex-col gap-2 items-center justify-center'>
            ...
            className="w-full bg-green-700 font-semibold text-md hover:bg-green-800">Confirm ride</Button>
        </div>
    </div>
  )
}
